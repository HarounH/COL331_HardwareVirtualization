...
static struct Command commands[] = {
	...
	{"backtrace", "Perform a backtrace", mon_backtrace}
};
...
/*
The following is not very nice because types don't match.
int
get_eip(void)
{
	return *(((int *)(read_ebp())) + 1);
}
*/
...
mon_backtrace(int argc, char **argv, struct Trapframe *tf)
{
	...
	int count = 0;
	cprintf("backtrace:\n"); 
	while (rbp != 0) {// have we been nuked?
